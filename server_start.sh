...
# Options
CONFIG="~/workspace/arm-stiffness-optimisation/config/ergocub.ini"
PORT="/ergocubSim"
URDF="~/workspace/robotology-superbuild/src/ergocub-software/urdf/ergoCub/robots/ergoCubGazeboV1/model.urdf"
WORLD="~/workspace/arm-stiffness-optimisation/gazebo/worlds/ergocub_grasp_demo.sdf"
...
tmux send-keys   -t $SESSION "~/workspace/arm-stiffness-optimisation/build/bin/command_server $SERVERNAME $PORT $URDF $CONFIG" Enter
